...
class LinuxInitrd(linux_kernel.BootKernelTest):
    ...
    def test_with_2gib_file_should_exit_error_msg_with_linux_v3_6(self):
        ...
        """
        self.fetch_kernel(provider_name='fedora', version='18', arch='x86_64')
        max_size = 2 * (1024 ** 3) - 1
        ...
        with tempfile.NamedTemporaryFile() as initrd:
            ...
            cmd = "%s -kernel %s -initrd %s -m 4096" % (
                  self.qemu_bin, self.kernel.path, initrd.name)
    ...
    def test_with_2gib_file_should_work_with_linux_v4_16(self):
        ...
        with tempfile.NamedTemporaryFile() as initrd:
            ...
            self.boot_kernel(provider_name='fedora', version='29',
                             arch='x86_64')
