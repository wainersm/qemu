...
class CPUHotplug(BootLinux):
    ...
    def test_x86_64_kvm(self):
        ...
        max_cpus = int(self.params.get('maxcpus', default=4))
        ...
        self.assertEqual(self.get_guest_cpu_online(), 1,
        ...
        for cpu in hotpluggable_cpus:
            ...
            i += 1
            self.assertEqual(self.get_guest_cpu_online(), i,
