...
class SmpOption(Test):
    ...
    def setUp(self):
        super().setUp()
        self.cores = int(self.params.get('cores', default=2))
        self.threads = int(self.params.get('threads', default=2))
        self.sockets = int(self.params.get('sockets', default=2))
        self.cpus = self.cores * self.threads * self.sockets
